...
# learning for 3s_vs_4z scenario
class QLearner_3s_vs_4z:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            ...
            for i in range(ss):
                smooth_loss += self.loss_weight[i] * (((dummy-previous_msg_list[i])**2).sum(dim = 1))/((ss*32*3*10*(dummy**2)).sum(dim = 1))
            ...
            agent_global_outputs =th.cat((agent0.view((32,1,10)),agent1.view((32,1,10)),agent2.view((32,1,10))),1)           
        ...
        for t in range(batch.max_seq_length):
            ...
            target_agent_global_outputs =th.cat((target_agent0.view((32,1,10)),target_agent1.view((32,1,10)),target_agent2.view((32,1,10))),1)     
