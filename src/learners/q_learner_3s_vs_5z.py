...
# learning for 3s_vs_5z scenario
class QLearner_3s_vs_5z:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.loss_weight = [0.5,1,1.5]  # this is the beta in Algorithm 1
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            ...
            for i in range(ss):
                smooth_loss += self.loss_weight[i] * (((dummy-previous_msg_list[i])**2).sum(dim = 1))/((ss*32*3*11*(dummy**2)).sum(dim = 1))
            ...
            dummy_final = dummy.reshape(32,3,11)
            ...
            agent_global_outputs =th.cat((agent0.view((32,1,11)),agent1.view((32,1,11)),agent2.view((32,1,11))),1)           
        ...
        for t in range(batch.max_seq_length):
            ...
            target_dummy_final = target_dummy.reshape(32,3,11)
            ...
            target_agent_global_outputs =th.cat((target_agent0.view((32,1,11)),target_agent1.view((32,1,11)),target_agent2.view((32,1,11))),1)     
        ...
        ######compute the smooth loss and robustness loss#########
